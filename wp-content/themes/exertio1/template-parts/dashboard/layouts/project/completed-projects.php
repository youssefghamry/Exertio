              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2><?php echo esc_html__('Completed Projects','exertio_theme').esc_html(' ('. $total_count.')');?></h2>
                                ...
                                while ( $the_query->have_posts() ) 
                                {
                                    ...
                                    ?>
                                      <div class="pro-box">
                                        ...
                                        <div class="pro-coulmn"><a href="<?php get_template_part( 'project-propsals' );?>?ext=completed-project-detail&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'View Details', 'exertio_theme' ); ?></a></div>
                                      </div>
                                    <?php
                                }
                            }
