						...
						while ( $the_query->have_posts() ) 
						{
							...
							?>
							  <div class="pro-box">
								...
								<div class="pro-coulmn"><a href="<?php get_template_part( 'project-propsals' );?>?ext=ongoing-project-proposals&project-id=<?php echo esc_html($pid); ?>" class="btn btn-theme-secondary"> <?php echo esc_html__( 'Proposals ', 'exertio_theme' ).' ('.$count_bids.')'; ?> </a></div>
							  </div>
