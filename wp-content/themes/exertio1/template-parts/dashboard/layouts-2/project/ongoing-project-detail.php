									...
									<form id="send_himstory_msg">
										<div class="form-row">
											<div class="form-group col-md-12">
												<textarea name="history_msg_text" id="" class="form-control fl-textarea" required data-smk-msg="<?php echo esc_attr__('Please provide message to send','exertio_theme'); ?>"></textarea>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
