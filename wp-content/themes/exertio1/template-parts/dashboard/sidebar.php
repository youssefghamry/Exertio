		...
		foreach($exertio_theme_options['employer_dashboard_sidebar_sortable'] as $key => $val)
		{
			...
			?>
				<li class="nav-item <?php if($page_name == 'meetings-settings') { echo 'active';} ?>">
					...
					<div class="collapse <?php if($page_name == 'meetings-settings' ){ echo 'show';} ?>" id="profile">
					  <ul class="nav flex-column sub-menu">
